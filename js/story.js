const STORY_EVENTS = Object.freeze([
    { id: "choose_starter", requires: [], trigger: { map: "city1", x: 10, y: 8 }, dialogue: ["Professor Cypress: The Grand Transit is failing. Choose a partner and carry this Railpass to Crown Central.", "Axel: Pick quickly. I'm already one station ahead."], sets: "hasStarter" },
    { id: "rival_departure", requires: ["hasStarter"], trigger: { map: "city1", x: 10, y: 14 }, battle: "rival_axel:0", sets: "rival1Defeated" },
    ...
    { id: "final_rival", requires: ["Crown Badge", "derailDefeated"], trigger: { map: "terminus", x: 6, y: 26 }, battle: "rival_axel:4", sets: "rivalFinalDefeated" },
    { id: "league", requires: ["rivalFinalDefeated"], trigger: { map: "terminus", x: 6, y: 2 }, dialogue: ["Eight badges open the Grand Gate. Four Conductors and the Champion await."], sets: "leagueOpen" },
    { id: "champion", requires: ["leagueOpen", "eliteCleared"], trigger: { map: "terminus", x: 6, y: 1 }, battle: "champion_cypress", sets: "gameComplete" },
    { id: "epilogue", requires: ["gameComplete"], trigger: { map: "city1", x: 10, y: 8 }, dialogue: ["The network is whole again. Every whistle across the region salutes its new Champion.", "THE END - The rails continue wherever you choose to travel."], sets: "epilogueSeen" }
]);
